...
import com.sele.mymunifaults.databinding.FragmentWastePageBinding
import com.sele.mymunifaults.userlocation
import java.util.*


class wastePage : Fragment() {
    private lateinit var FirebaseAuth: FirebaseAuth
    private lateinit var database: DatabaseReference
    lateinit var fusedLocationClient: FusedLocationProviderClient
    private lateinit var binding: FragmentWastePageBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentWastePageBinding.inflate(inflater, container, false)

        var faultcategories = arrayOf("Garbage disposal","municipality Littering", "harzardous waste","no Recycling","Waste collection","Chemical wastee","Other wasteFault")
        ...
        addphoto()
        binding.wastebtnfaultreport.setOnClickListener {
