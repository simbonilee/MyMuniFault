...
import com.sele.mymunifaults.databinding.FragmentOtherServicesPageBinding
import com.sele.mymunifaults.userlocation
import java.util.*


class otherServicesPage : Fragment() {

    lateinit var fusedLocationClient: FusedLocationProviderClient
    private lateinit var FirebaseAuth: FirebaseAuth
    private lateinit var database: DatabaseReference
    private lateinit var binding: FragmentOtherServicesPageBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOtherServicesPageBinding.inflate(inflater, container, false)

        var faultcategories = arrayOf(
            "Muni Sanitation",
            "Muni Recreation",
            "Fire hydrants leaks",
            "Health care",
        ...
        val textView: AutoCompleteTextView = binding.otherCategoryEditT
        ...
        binding.btnfaultreport.setOnClickListener {
            val category = binding.otherCategoryEditT.text.toString()
            val location = binding.otheraddressEditT.text.toString()
            val description= binding.otherfaultDescriptionEditT.text.toString()
    ...
    private fun getLocation() {
        fusedLocationClient.lastLocation.addOnSuccessListener { location: Location? ->
            ...
            binding.otheraddressEditT.setText(current_address)
        }
    }
    ...
    private fun addphoto() {
            ...
            binding.Btnaddimage.setOnClickListener {
                if (ContextCompat.checkSelfPermission(
                    ...
                    Toast.makeText(activity, "Read permision is not granted", Toast.LENGTH_SHORT)
                        .show()
                }
