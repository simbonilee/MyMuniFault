...
class waterpage : Fragment() {
    ...
    private lateinit var binding: FragmentWaterpageBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentWaterpageBinding.inflate(inflater, container, false)
        var faultcategories = arrayOf("Dirty water","water Leakage", "Burst water pipe","Meter related","Water theft","Exposed water pipes","Other waterFault")
        ...
        addphoto()
        binding.waterbtnfaultreport.setOnClickListener {
